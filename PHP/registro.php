...
$apellidoUsuario= $_POST['apellidoUser'];
$dni= $_POST['dni'];
$genero = $_POST['genero'];
...
$accesoTabla = "INSERT INTO usuarios (usuario, password, Nombre, Apellidos, DNI, Genero, Direccion, localidad, CP, Provincia, Telefono) VALUES ('$usuario', '$contrasenia', '$nombreUsuario', '$apellidoUsuario','$dni', '$genero','$direccion','$localidad','$codigoPostal','$provincia','$telefonoMovil')";
mysqli_query($conexion,$accesoTabla);
echo "user insertado correctamente";
// hago la conexión a la base de batos, 
